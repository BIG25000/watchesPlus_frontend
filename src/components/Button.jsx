const bgClass = {
  brown: "bg-gradient-to-t from-stone-500 to-stone-700 hover:bg-gradient-to-t hover:from-stone-600 hover:to-stone-800",
  // brown: "bg-brown hover:bg-amber-600",
  scarlet: "bg-gradient-to-tr from-rose-600 to-red-800 hover:bg-gradient-to-tr hover:from-rose-700 hover:to-red-900",
