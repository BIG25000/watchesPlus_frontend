        ...
        <div className="mx-auto w-[1200px]  min-h-screen  flex flex-col gap-10 py-12">
                ...
                {pendingData?.length > 0 ? (
                  <div className="flex flex-col">
                    ...
                    <div className="flex flex-col my-8 ">
                      <TableList pending={pendingData} setLoading={setLoading}/>
                    </div>
                  </div>
                ) : (
              ...
              >
                {waitingData?.length > 0 ? (
                  <div className="flex flex-col">
                    ...
                    <div>
                    <TableList waitingData={waitingData}  setLoading={setLoading}/>
                    </div>
                  </div>
                ) : (
                  <div className="w-full flex flex-col justify-center items-center">
                ...
                {shippingData?.length > 0 ? (
                  <div className="flex flex-col">
                    ...
                    <div className="flex">
                      {activeData.map((e) => {
                        return (
                          <CardProduct data={e.watch} id={e.id} key={e.id} />
                        );
                      })}
                    </div>
                  </div>
          ...
          {activeData?.length > 0 ? (
            <div className="flex flex-col">
              ...
              <div>
                <TableList activeData={activeData} setLoading={setLoading} />
              </div>
            </div>
          ) : (
            <div className="w-full flex flex-col justify-center items-center">
