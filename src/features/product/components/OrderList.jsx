    ...
    <>
      {data.type === "TRANSFER" && (
        <div className="flex items-center h-16 px-4 gap-12 border-b-2 hover:bg-gray-200">
          <div className="flex items-center gap-4">
            <img className="w-10 h-10 rounded-full" src={data?.fromWallet?.user?.profileImage} />
          ...
          <div className="flex items-center gap-4">
            <img className="w-10 h-10 rounded-full" src={data?.toWallet?.user?.profileImage} />
      ...
      {data.type === "PLACED" && (
        <div className="flex items-center h-16 px-4 gap-12 border-b-2 hover:bg-gray-200">
          ...
          <div className="flex items-center gap-4">
            <img className="w-10 h-10" src={watch?.watchImage} />
          </div>
          <div className="flex items-center gap-4">
            <span>for</span>
            <span>{baht + " " + formatNum(data?.price)}</span>
